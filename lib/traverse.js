...
const { get, freezeSeal } = require('./utils/object.js');
const { indent, formatType } = require('./utils/format.js');
const { fragmentNodeFor } = require('./utils/fragment.js');
const { TextSource } = require('./sources/text.js');
const { TokensSource } = require('./sources/tokens.js');
...
const traverseFragment = (node, grammar, options = {}) => {
  ...
  const grammar_ = new Grammar(grammar);
