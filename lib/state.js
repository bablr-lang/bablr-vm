...
class State {
  constructor(
    ...
    // We can't pass co to the constructor because it needs to be initialized with a state
    this.co = undefined;
    this.status = 'active';
  ...
  branch() {
    ...
    const nextState = new State(this.path, this.source, this.resolver, this.result, this);

    nextState.co = this.co;
