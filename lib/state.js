...
export const State = class BABLRState {
  ...
  push(source, context, languages, spans, resultPath, depths, holding, node) {
    return new State(this, source, context, languages, spans, resultPath, depths, holding, node);
  }
  ...
  branch() {
    let baseState = this;
    let { source, context, spans, resultPath, depths, holding, node, languages } = baseState;
