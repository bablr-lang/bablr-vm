...
export const buildNodeOpenTag = (type, path, attributes) => {
  return _t.node("CSTML", "OpenNodeTag", [_t.ref`open`, _t.ref`type`, _t.trivia` `, _t.ref`pathKeyword`, _t.ref`path`, _t.trivia` `, _t.ref`attributes`, _t.ref`close`], {
    open: _t.node("CSTML", "Punctuator", [_t.lit`<`], {}, {}),
    type: type,
    pathKeyword: _t.node("CSTML", "Punctuator", [_t.lit`.`], {}, {}),
    path: path,
    attributes: [..._interpolateArray(attributes)],
    close: _t.node("CSTML", "Punctuator", [_t.lit`>`], {}, {})
  }, {});
};
export const buildNodeCloseTag = () => {
  return _t.node("CSTML", "CloseNodeTag", [_t.ref`open`, _t.ref`close`], {
    open: _t.node("CSTML", "Punctuator", [_t.lit`</`], {}, {}),
    close: _t.node("CSTML", "Punctuator", [_t.lit`>`], {}, {})
  }, {});
};
