...
export class Path extends WeakStackFrame {
  static from(context, parentProperty, parentPropertyType) {
    const path = new Path(context, parentProperty, parentPropertyType);

    return path;
  }

  constructor(context, parentProperty = null, parentPropertyType = null) {
    super();
