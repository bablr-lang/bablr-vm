...
import { getMixedIterator } from '@bablr/helpers/source';
...
class Exchange {
  ...
  static from(iterable) {
    return new Exchange(getMixedIterator(iterable));
  }
...
export const SourceFacade = class BABLRSourceFacade {
  ...
  [Symbol.for('@@mixedIterator')]() {
    return actuals.get(this)[Symbol.for('@@mixedIterator')]();
  }
...
export const Source = class BABLRSource extends WeakStackFrame {
  ...
  [Symbol.for('@@mixedIterator')]() {
    return this.fork.clone()[Symbol.for('@@mixedIterator')]();
  }
