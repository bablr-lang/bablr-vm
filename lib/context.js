...
export const Context = class BABLRContext {
  ...
  validateLanguage(language) {
    ...
    let { canonicalURL, defaultMatcher, dependencies, fragmentProduction, context } = language;
    ...
    if (context != null && !isDeepFrozen(context))
    ...
    while (prototype !== Object.prototype) {
      if (!isFrozen(prototype.constructor)) {
        throw new Error(
          prototype.constructor.canonicalURL + ' missing Object.freeze(bablrLanguage)',
        );
      }
      if (!isFrozen(prototype)) {
        throw new Error(
          prototype.constructor.canonicalURL + ' missing Object.freeze(bablrLanguage.prototype)',
        );
      }
