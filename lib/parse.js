...
import { evaluateSync, evaluateAsync } from './evaluate.js';
...
export function streamParseSync(language, sourceText, matcher) {
  ...
  return evaluateSync(ctx, source, parseTrampoline(matcher));
}
...
export function streamParseAsync(language, sourceText, matcher) {
  ...
  return evaluateAsync(ctx, source, parseTrampoline(matcher));
}
...
export function* parseTrampoline(rootMatcher, rootProps) {
